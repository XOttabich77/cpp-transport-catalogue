        ...
        T At(const std::string& key) const {
            if (this->IsMap()) {
                if constexpr (std::is_same_v<T, std::string>) {
                    if (AsMap().at(key).IsString()) {
                        return AsMap().at(key).AsString();
                    }
                    else {
                ...
                if constexpr (std::is_same_v<T, int>) {
                    if (AsMap().at(key).IsInt()) {
                        return AsMap().at(key).AsInt();
                    }
                    else {
                ...
                if constexpr (std::is_same_v<T, double>) {
                    if (AsMap().at(key).IsDouble()) {
                        return AsMap().at(key).AsDouble();
                    }
                    else {
